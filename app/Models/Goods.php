...
class Goods extends Model
{
    ...
    public function getItems()
    {
        ...
        $qry = $this->select('category', DB::Raw("if(top_category = '탱화',  CONCAT(size,'cm(액자포함)'), CONCAT(size,'(cm)')) as size"),DB::Raw("IFNULL(CONCAT(size2,'(cm)'), '') AS size2"),'size3','name','id','code', 'code2','file_name','top_category')
